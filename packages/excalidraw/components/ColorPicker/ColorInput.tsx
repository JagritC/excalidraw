...
export const ColorInput = ({
  ...
  const [hasInvalidColor, setHasInvalidColor] = useState(false);
  ...
  const changeColor = useCallback(
    (inputValue: string) => {
      ...
      if (value.trim() && !isValidHexColorInput(value)) {
        setHasInvalidColor(true);
        return;
      }
    ...
    <div className="color-picker__input-container">
      <div
        className={clsx("color-picker__input-label", {
          "color-picker__input-label--invalid": hasInvalidColor,
        })}
      >
        ...
        <input
          ...
          aria-describedby={hasInvalidColor ? errorMessageId : undefined}
          onChange={(event) => {
